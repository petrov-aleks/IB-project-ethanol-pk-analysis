...
# Данные по крысам
```{r rat data}
Eriksson_1977 <- read_csv("data/raw/Eriksson-1977.csv")

Kozawa_2007 <- read_csv("data/raw/Kozawa-2007.csv")

rat_data <- bind_rows(Kozawa_2007,Eriksson_1977) %>% mutate(time_min = time_h * 60) %>% mutate(wt_kg = BW_g/1000)
