...
p7 + p8 + plot_annotation(title = "Распределение Tmax по способу введения", theme = theme(plot.title = element_text(size = 20)))
...
p9 + p10 + plot_annotation(title = "Распределение Cmax по способу введения", theme = theme(plot.title = element_text(size = 20)))
...
p11 + p12 + plot_annotation(title = "Распределение AUC по способу введения", theme = theme(plot.title = element_text(size = 20)))
```
...
p13 + p14 + plot_annotation(title = "Распределение Tmax по статусу приёма пищи", theme = theme(plot.title = element_text(size = 20)))
...
p15 + p16 + plot_annotation(title = "Распределение Cmax по статусу приёма пищи", theme = theme(plot.title = element_text(size = 20)))
...
p17 + p18 + plot_annotation(title = "Распределение AUC по статусу приёма пищи", theme = theme(plot.title = element_text(size = 20)))
```
```{r, warning=FALSE, message=FALSE, fig.width=12, fig.height=5}
p19 <- main_df %>% 
...
p19 + p20 + plot_annotation(title = "Распределение Tmax по забору крови", theme = theme(plot.title = element_text(size = 20)))
...
p21 + p22 + plot_annotation(title = "Распределение Cmax по забору крови", theme = theme(plot.title = element_text(size = 20)))
...
p23 + p24 + plot_annotation(title = "Распределение AUC по забору крови", theme = theme(plot.title = element_text(size = 20)))
...
```{r fit_lm}
fit_AUC_mod_int1 <- lm(log(AUC) ~ dose_g_per_kg*route + site, order_0_df)
...
summary(fit_AUC_mod_int1)
#summary(fit_AUC_submod)

cat("\n===============================================================\n")

anova(fit_AUC_mod, fit_AUC_mod_int1)
cat("\n===============================================================\n")
anova(fit_AUC_mod, fit_AUC_mod_int2)
cat("\n===============================================================\n")
anova(fit_AUC_mod, fit_AUC_mod_int3)
cat("\n===============================================================\n")
#anova(fit_AUC_mod, fit_AUC_mod_int4)
```
...
1. После включения `sex` в модель меняется `Intercept` и коэффициент при `dose_g_per_kg`.